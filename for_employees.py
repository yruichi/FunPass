...
from tkinter import ttk, messagebox # Importing ttk for themed widgets
...
import matplotlib.pyplot as plt # Importing matplotlib for plotting graphs but since we dont hav graphs, we can remove this
from matplotlib.backends.backend_tkagg import FigureCanvasTkAgg 
from tkcalendar import DateEntry # Importing DateEntry for date selection
import pandas as pd # Importing pandas for data manipulation
from shared import create_database, BaseWindow # Importing shared functions and classes
import customtkinter as ctk # Importing customtkinter for modern UI components
import tkinter.ttk as ttk # Importing ttk for themed widgets
import time
import smtplib
...
class EmployeeDashboard:
    ...
    def show_customers(self):
        ...
        for col in columns:
            ...
            if col in ["Name", "Email", "Pass Type"]:
                self.customers_tree.column(col, width=width, anchor='w')
            else:
                self.customers_tree.column(col, width=width, anchor='center')
    ...
    def add_customer_dialog(self):
        ...
        def save_customer():
            ...
            try:
                ...
                purchased_dt = datetime.strptime(purchased_date, "%Y-%m-%d")
                if booked_dt < purchased_dt:
                    messagebox.showerror("Error", "Booking date cannot be earlier than the purchase date!")
                    return
            except Exception:
    ...
    def send_ticket_email(self, to_email, ticket_id, name, email, quantity, amount, booked_date, purchased_date, pass_type):
        # Configure SMTP server details here
...
"""
    ...
    def show_pricing(self):
        ...
        header_row.grid_columnconfigure(0, weight=1)
        pricing_title = ctk.CTkLabel(header_row, text="Pass Type Pricing", font=("Segoe UI", 22, "bold"), text_color="#22223B")
